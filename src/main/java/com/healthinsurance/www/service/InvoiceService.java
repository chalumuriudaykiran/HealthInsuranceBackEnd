...
public class InvoiceService {
    ...
    private RegisterationPage registerDetail;
    private List<PaymentPage> paymentDetails;

    @Autowired
    public InvoiceService(RegisterRepository registerRepo, PaymentRepository paymentRepo) {
    ...
    public RegisterationPage getRegisterDetail() {
        return registerDetail;
    }

    public List<PaymentPage> getPaymentDetails() {
    ...
    private void writeTableData(PdfPTable table) {
        table.addCell(registerDetail.getUname());
    ...
    public void export(HttpServletResponse response) throws DocumentException, IOException {
        ...
        try {
            try {
                String imagePath = "E:\\images\\WhatsApp Image 2024-06-18 at 10.39.36_d00c3504.jpg"; // Ensure this is correct
            ...
            pC.add("Mobile Number: " + registerDetail.getPhn());
            document.add(pC);
            contentAdded = true;
